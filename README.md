...
As AI systems become more prevalent, tracking their failures transparently is critical for building trust and improving safety. This platform provides a decentralized, tamper-proof record that holds AI systems accountable while enabling the safety research community to learn from incidents globally.

Website: 
Paper:
Demo video:

This project was created for the Apart Technical AI Governance Challenge in Januray 2026. The development team consisted of Augusta Lina, Caleb Rudnick and Dennis Kiptanui.

Please note that in order to test the notary, an account with MetaMask needs to be created. 
